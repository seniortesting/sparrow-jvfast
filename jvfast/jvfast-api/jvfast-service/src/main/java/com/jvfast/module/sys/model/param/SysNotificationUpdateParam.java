...
@Data
@NoArgsConstructor
@ApiModel(value = "SysNotificationUpdateParam对象", description = "修改系统通知表(邮件,短信,微信公众号消息,微信小程序消息,app消息)请求参数")
public class SysNotificationUpdateParam implements Serializable {
