...
@Data
@NoArgsConstructor
@ApiModel(value = "SysCityAddParam对象", description = "添加国家城市数据库：https://github.com/xiangyuecn/AreaCity-JsSpider-StatsGov/blob/master/README.md请求参数")
public class SysCityAddParam implements Serializable {
