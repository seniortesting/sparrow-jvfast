<template>
  <div class="__nuxt-error-page">
    <div class="error">
          ...
          <g id="404" transform="translate(-484.000000, -221.000000)">
            <g id="Group-4" transform="translate(464.000000, 222.000000)">
              ...
              <path
                ...
                fill="#FAFAFA"
              />
              <path id="Line-2" d="M421.5,321.5 L423,323" stroke="#979797" stroke-linecap="square" />
            </g>
          </g>
        </g>
      </svg>
      ...
      <div v-if="statusCode === 404" class="title">
        抱歉，你访问的页面不存在
      </div>
      <div v-else class="title">
        应用发生异常错误,错误信息: {{ message }}
      </div>
      <p class="description">
  ...
  head () {
    return {
      ...
      meta: [
        ...
        { hid: 'description', name: 'description', content: 'JV-Fast Error Page' }
      ]
    }
  }
}
